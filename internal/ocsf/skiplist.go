...
var skiplist = map[string]string{
	...
	"directory":        "non-event filesystem entry type literal discovered by the syntax scanner",
	"regular":          "non-event filesystem entry type literal discovered by the syntax scanner",
	"symlink":          "non-event filesystem entry type literal discovered by the syntax scanner",
