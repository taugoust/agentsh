...
func TestStartNotifyHandler_NilSocket_NoOp(t *testing.T) {
	...
	startNotifyHandler(context.Background(), nil, "test-session", pol, store, broker, nil, config.SandboxSeccompFileMonitorConfig{}, false, nil, nil, nil, nil)
}
...
func TestStartNotifyHandler_NilPolicy_NoOp(t *testing.T) {
	...
	startNotifyHandler(context.Background(), r, "test-session", nil, store, broker, nil, config.SandboxSeccompFileMonitorConfig{}, false, nil, nil, nil, nil)
}
